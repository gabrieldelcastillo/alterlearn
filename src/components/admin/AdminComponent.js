    ...
    <div className="flex flex-col md:flex-row h-screen bg-gray-100">
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Career</th>
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="mt-auto pt-4 flex items-center justify-center gap-4">
            ...
            <span className="text-gray-700 font-medium">
              Page {selectedDocument.currentPage} of {selectedDocument.pages}
            </span>
            <button
      ...
      <div className="w-full md:w-1/3 p-4 bg-white shadow-lg flex flex-col justify-center">
        <div className="space-y-4">
          <h3 className="text-xl font-semibold mb-4 text-gray-700">File Info</h3>
          ...
          <h3 className="text-xl font-semibold mb-4 text-gray-700">Resource Info</h3>
          <div className="space-y-4 mb-8">
            <div className="flex justify-between p-3 bg-gray-50 rounded-lg">
