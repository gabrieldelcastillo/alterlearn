    ...
    <div style={{ fontFamily: 'Arial, sans-serif', display: 'flex', height: '100vh', border: '1px solid #ccc' }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <header style={{ padding: '10px 20px', borderBottom: '1px solid #ccc', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <Link href="/init"><button style={{ marginRight: '10px' }}>Menú</button></Link>
            <button style={{ marginRight: '10px' }}>Compras</button>
            <Link href="/publish"><button style={{ marginRight: '10px' }}>Vender</button></Link>
            <button>Ayuda</button>
          </div>
          <input 
            type="text" 
          ...
          />
          <div>
            <Link href="/cart"><button style={{ marginRight: '10px' }}>Cart</button></Link>
            <button>Notificaciones</button>
          </div>
        </header>

        {/* Área de mensajes */}
        <div style={{ flex: 1, display: 'flex', padding: '20px', overflowY: 'auto' }}>
          <div style={{ marginRight: 'auto', background: '#eee', padding: '10px 15px', borderRadius: '15px', marginBottom: '10px', maxWidth: '50%' }}>
            entonces te lo rebajo 500
          </div>
          <div style={{ marginLeft: 'auto', background: '#d1ffd1', padding: '10px 15px', borderRadius: '15px', marginBottom: '10px', maxWidth: '50%' }}>
            vale, gracias
          </div>
        </div>

        {/* Input para enviar mensajes */}
        <footer style={{ display: 'flex', alignItems: 'center', padding: '10px', borderTop: '1px solid #ccc' }}>
          ...
          />
          <button style={{ marginLeft: '10px', padding: '10px 20px', borderRadius: '5px', backgroundColor: '#007bff', color: 'white', border: 'none' }}>
            Enviar
          </button>
        </footer>
      </main>
