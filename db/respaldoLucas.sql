...
--
-- Host: localhost    Database: alterlean
-- ------------------------------------------------------
...
CREATE TABLE `administrador` (
  ...
  `nombre_admin` varchar(16) DEFAULT NULL,
  `correo_admin` varchar(30) DEFAULT NULL,
...
CREATE TABLE `asignatura` (
  ...
  `nombre_asignatura` varchar(65) DEFAULT NULL,
...
CREATE TABLE `publicacompra` (
  ...
  CONSTRAINT `publicacompra_ibfk_3` FOREIGN KEY (`id_recurso`) REFERENCES `recurso` (`id_recurso`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `publicacompra` VALUES (1,11,11,'2024-01-10','2024-01-11'),(2,12,12,'2024-02-12','2024-02-13'),(3,13,13,'2024-03-14','2024-03-15'),(4,14,14,'2024-04-16','2024-04-17'),(5,15,15,'2024-05-18','2024-05-19'),(6,16,16,'2024-06-20','2024-06-21'),(7,17,17,'2024-07-22','2024-07-23'),(8,18,18,'2024-08-24','2024-08-25'),(9,19,19,'2024-09-26','2024-09-27'),(10,20,20,'2024-10-28','2024-10-29');
...
CREATE TABLE `recurso` (
  ...
  CONSTRAINT `recurso_ibfk_1` FOREIGN KEY (`nombre_asignatura`) REFERENCES `asignatura` (`nombre_asignatura`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `recurso_ibfk_2` FOREIGN KEY (`nombre_asignatura`) REFERENCES `asignatura` (`nombre_asignatura`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `recurso` VALUES (11,2000,'Control Matematicas 1','Certamen Matematicas 1','Certamen Matematicas 2','Tarea Algebra','Prof. Martin Vega','Matemáticas'),(12,4000,'Control Fisica 1','Certamen Fisica 1','Certamen Fisica 2','Tarea Física I','Prof. Elena Robles','Física'),(13,2000,'Control Quimica 1','Certamen Quimica 1','Certamen Quimica 2','Tarea Química Orgánica','Prof. Alberto Sánchez','Química'),(14,2000,'Control Biología 1','Certamen Biología 1','Certamen Biología 2','Tarea Genética','Prof. Javier Torres','Biología'),(15,1000,'Control Arte 1','Certamen Arte 1','Certamen Arte 2','Tarea Renacimiento','Prof. Laura Fernández','Historia del Arte'),(16,1000,'Control Lengua 1','Certamen Lengua 1','Certamen Lengua 2','Tarea Gramática','Prof. Carmen López','Lengua Española'),(17,1000,'Control Geografía 1','Certamen Geografía 1','Certamen Geografía 2','Tarea Geografía Humana','Prof. Julio Paredes','Geografía'),(18,3000,'Control Informática 1','Certamen Informática 1','Certamen Informática 2','Tarea Programación','Prof. Roberto Iglesias','Informática'),(19,2000,'Control Economía 1','Certamen Economía 1','Certamen Economía 2','Tarea Microeconomía','Prof. Alicia Ortega','Economía'),(20,1000,'Control Música 1','Certamen Música 1','Certamen Música 2','Tarea Teoría Musical','Prof. Daniel Castro','Música Clásica');
...
INSERT INTO `supervisado` VALUES (1,11,1,1),(2,12,2,1),(3,13,3,1),(4,14,4,1),(5,15,5,0),(6,16,6,1),(7,17,7,0),(8,18,8,1),(9,19,9,1),(10,20,10,0);
...
-- Dump completed on 2024-09-25 23:11:20
